# .NET 10.0 Upgrade Progress

## Overview

Upgrading 12 projects in LiveSPICE from .NET Standard 2.0 / .NET 6 / .NET 8 to .NET 10.0 using a bottom-up strategy, progressing from foundation libraries to top-level applications.
